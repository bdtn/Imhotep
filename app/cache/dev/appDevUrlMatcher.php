...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/imhotep')) {
            ...
            // issue
            if ($pathinfo === '/imhotep/issue') {
                return array (  '_controller' => 'Bd\\ImhotepBundle\\Controller\\IssueController::indexAction',  '_route' => 'issue',);
            }

            // bd_issue_new
            if ($pathinfo === '/imhotep/new') {
                return array (  '_controller' => 'Bd\\ImhotepBundle\\Controller\\IssueController::newAction',  '_route' => 'bd_issue_new',);
            }

            // issue_create
            if ($pathinfo === '/imhotep/create') {
                return array (  '_controller' => 'Bd\\ImhotepBundle\\Controller\\IssueController::createAction',  '_route' => 'issue_create',);
            }

            // bd_project_new
            if ($pathinfo === '/imhotep/addproject') {
                return array (  '_controller' => 'Bd\\ImhotepBundle\\Controller\\ProjectController::newAction',  '_route' => 'bd_project_new',);
            }

            // project
            if ($pathinfo === '/imhotep/issue') {
                return array (  '_controller' => 'Bd\\ImhotepBundle\\Controller\\ProjectController::indexAction',  '_route' => 'project',);
            }

            // project_create
            if ($pathinfo === '/imhotep/createproject') {
                return array (  '_controller' => 'Bd\\ImhotepBundle\\Controller\\ProjectController::createAction',  '_route' => 'project_create',);
            }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                // login
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'Bd\\UserBundle\\Controller\\DefaultController::loginAction',  '_route' => 'login',);
                }
