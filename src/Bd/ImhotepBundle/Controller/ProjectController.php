...
use Bd\ImhotepBundle\Entity\Project;
 use Bd\ImhotepBundle\Form\ProjectType;
...
class ProjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BdImhotepBundle:Project')->findAll();
     ...
     * @Method("POST")
     * @Template("BdImhotepBundle:Issue:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BdImhotepBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BdImhotepBundle:Issue:edit.html.twig")
     */
