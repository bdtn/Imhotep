 ...
 */
class Client extends \Bd\ImhotepBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'phone', 'tel', 'email', 'adress', 'createdAt', 'updatedAt');
        }
